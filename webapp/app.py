...
def main_page():
    ...
    subtitle="Courtesy of Laura Bartolini, Behzad Azarhoushang, Nikita Grabin (guest star) & Francesco Mari",
...
def rec_page():
    ...
    logging.warning(f'A new user inserted new ratings: {html_form_data}.')
    ...
    logging.warning("New recommendations generated based on the user's input.")
